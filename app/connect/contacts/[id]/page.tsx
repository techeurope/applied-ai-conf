...
export default function ContactDetailPage({
  ...
  if (!entry) {
    return (
      <div className="space-y-4">
        ...
        <Link href="/connect/contacts" className="font-mono text-xs underline">
          ← Back to contacts
        </Link>
      </div>
    );
  ...
  return (
    <div className="space-y-5 pt-2">
      <Link href="/connect/contacts" className="font-mono text-xs text-zinc-500 hover:text-zinc-300">
        ← Contacts
      </Link>
