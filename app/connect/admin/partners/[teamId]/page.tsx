  ...
  if (team === null) {
    return (
      <div className="space-y-2">
        ...
        <Link href="/connect/admin/partners" className="font-mono text-xs underline">
          ← partners
        </Link>
      </div>
    );
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between gap-2">
        <Link href="/connect/admin/partners" className="font-mono text-xs text-white/40 underline">
          ← partners
        </Link>
        <Link
