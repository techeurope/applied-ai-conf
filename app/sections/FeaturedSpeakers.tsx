            ...
            >
              ...
              {speaker.linkedinUrl ? (
                <Link
                  ...
                  className="relative aspect-[3/4] w-full overflow-hidden bg-zinc-900 rounded-xl border border-white/10 shadow-[0_0_20px_rgba(255,255,255,0.05)] transition-colors duration-300 group-hover:border-green-900/60 group-hover:shadow-[0_0_20px_rgba(0,255,0,0.05)] block"
                >
                  {speaker.image ? (
                    <Image
                      src={speaker.image}
