...
export default function CallToAction() {
  return (
    <section className="relative overflow-hidden py-20 sm:py-24 min-h-[75vh] flex items-center">
      {/* Background gradient */}
      ...
      <div className="relative mx-auto w-full max-w-4xl px-6 lg:px-8">
        ...
        <div className="mb-12 text-center">
          ...
          <p className="mx-auto mt-6 max-w-2xl text-lg text-gray-400 leading-relaxed">
            We are building this conf in public.
          </p>
        </div>
        ...
        <div className="flex justify-center">
          <div className="relative overflow-hidden group rounded-2xl">
            ...
            <div 
              ...
              style={{
                background: 'linear-gradient(to bottom, #3b82f6 0%, #8b5cf6 25%, #ec4899 50%, #f97316 75%, transparent 100%)'
              }}
            />
