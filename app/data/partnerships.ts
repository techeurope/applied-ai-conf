...
const PARTNERSHIP_TIERS = [
  {
    ...
    price: '€60,000',
    description: 'For global infrastructure and developer platforms seeking headline visibility.',
  ...
  },
  {
    name: 'Gold Partner',
    price: '€25,000',
    description: 'For companies seeking both thought leadership and product exposure.',
    includes: [
  ...
  },
  {
    name: 'Silver Partner',
    price: '€12,000',
    description: 'For companies focused on strong visibility and product exposure.',
    includes: [
      'Medium expo booth',
...
export const PARTNERSHIP_OVERVIEW = {
  about: [
    'Applied AI in Europe is a one-day gathering for Europe’s leading AI founders, engineers, and global infrastructure companies.',
