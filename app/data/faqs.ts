...
export const FAQS = [
  {
    question: 'What is Applied AI Conf?',
  ...
  },
  {
    ...
    answer: "Absolutely! Please contact us and we'll do our best to accommodate your needs.",
  },
  {
    question: 'Do you have any travel and hotel recommendations?',
    answer: 'Yes, we have partnered with several hotels near The Midway. Details will be sent to registered attendees.',
  },
] satisfies FAQ[];
