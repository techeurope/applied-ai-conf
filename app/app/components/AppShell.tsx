...
export function AppShell({ children }: { children: ReactNode }) {
  ...
  // Defer the skeleton → real-tabs swap until after hydration. See
  // `useHasHydrated` for why this is the right primitive — short version:
  // `useCachedQuery` hydrates from localStorage synchronously on the
  // client, so the first client render can already see `tabsReady === true`
  // while the server (no localStorage) rendered the skeleton.
